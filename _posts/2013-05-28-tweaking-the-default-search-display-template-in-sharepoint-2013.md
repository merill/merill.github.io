...
<img class="alignnone size-full wp-image-822" alt="Search Result" src="{{ site.url }}{{ site.baseurl }}/wp-content/uploads/2013/05/Search-Result.png" width="507" height="127" />
...
<img class="alignnone size-full wp-image-823" alt="DisplayTemplate" src="{{ site.url }}{{ site.baseurl }}/wp-content/uploads/2013/05/DisplayTemplate.png" width="812" height="667" />
