...
<a href="https://merill.net/wp-content/uploads/2010/06/K2-Multiple-Destination-Workflow.png"><img class="alignnone size-full wp-image-691" title="K2 Multiple=" src="{{ site.url }}{{ site.baseurl }}/wp-content/uploads/2010/06/K2-Multiple-Destination-Workflow.png" alt="" width="696" height="478" /></a>
...
<img class="alignnone size-full wp-image-696" title="K2 Add Process Xml Field" src="{{ site.url }}{{ site.baseurl }}/wp-content/uploads/2010/06/K2-Add-Process-Xml-Field.png" alt="" width="306" height="192" />

Name the field 'Reviewers'.

<img class="alignnone size-full wp-image-697" title="K2 Add Xml Field Dialog" src="{{ site.url }}{{ site.baseurl }}/wp-content/uploads/2010/06/K2-Add-Xml-Field-Dialog.png" alt="" width="462" height="205" />
...
<img class="alignnone size-full wp-image-698" title="K2 Xml Field Step" src="{{ site.url }}{{ site.baseurl }}/wp-content/uploads/2010/06/K2-Xml-Field-Step.png" alt="" width="188" height="183" />
...
<img class="alignnone size-full wp-image-703" title="K2 Setup Destination 1" src="{{ site.url }}{{ site.baseurl }}/wp-content/uploads/2010/06/K2-Setup-Destination-1.png" alt="" width="560" height="281" />

Select 'Create a slot for each destination', this way each destination user get's their own slot.

<img class="alignnone size-full wp-image-704" title="K2 Setup Destination 2" src="{{ site.url }}{{ site.baseurl }}/wp-content/uploads/2010/06/K2-Setup-Destination-2.png" alt="" width="543" height="328" />

Click on the Edit button to configure the Destination sets.

<img class="alignnone size-full wp-image-705" title="K2 Setup Destination 3" src="{{ site.url }}{{ site.baseurl }}/wp-content/uploads/2010/06/K2-Setup-Destination-3.png" alt="" width="532" height="198" />
...
<img class="alignnone size-full wp-image-706" title="K2 Setup Destination 4" src="{{ site.url }}{{ site.baseurl }}/wp-content/uploads/2010/06/K2-Setup-Destination-4.png" alt="" width="734" height="323" />
